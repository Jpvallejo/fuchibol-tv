...
const CHANNEL_IMAGE_BY_NUMBER: Record<number, string> = {
  ...
  11: '/logo/11-logo-tvpublica-20210302.png',
  13: '/logo/13-logos-CANAL9-2705.png',
  15: '/logo/15-logos-TN-2705.png',
  16: '/logo/16-logo-A24_80-20250210.png',
  17: '/logo/17-logos-C5Nhd-270218.png',
  18: '/logo/18-logos-CRONICA-2705.png',
  19: '/logo/19-logos-CANAL26-2705.png',
  20: '/logo/20-logo-lnmas-03082017.png',
  50: '/logo/50-logos-TYCSPORTS-2705.png',
  51: '/logo/51-ESPN_tv_rojo.png',
  52: '/logo/52-ESPN2_rojo.png',
  53: '/logo/53-logo-ESPN3-20210302.png',
  54: '/logo/54-LOGO-foxsports-202302.png',
  55: '/logo/55-LOGO-foxsports2-202302.png',
  56: '/logo/56-LOGO-foxsports3-202302.png',
  58: '/logo/58-ESPN_PREMIUM.png',
  59: '/logo/59-logo-TNTSportsPremium20250123.png',
  60: '/logo/60-logos-DXTV-2705.png',
  63: '/logo/63-logos-TURBO-2705.png',
  64: '/logo/64-logos-ELGARAGE-2705.png',
  ...
  124: '/logo/124-espn4-20231602.png',
  ...
  169: '/logo/169.png',
  184: '/logo/184.png',
  193: '/logo/193-logo-NICKHD-11.png',
  195: '/logo/195-logos-DISNEYHD-2705.png',
  197: '/logo/197-logo-DISCOVERYKIDSHD-03082017.png',
  198: '/logo/198-disneyjr-web20240808.png',
  200: '/logo/200-logos-AXN-2705.png',
  201: '/logo/201-cinecanal.png',
  202: '/logo/202-logos-EUROCHANNEL-2705.png',
  205: '/logo/205-LOGO_STAR_CHANNEL.svg',
  208: '/logo/208-logos-SONY-08082019.png',
  210: '/logo/210-LOGO-sonyMovies.png',
  ...
  222: '/logo/222.png',
  300: '/logo/300-logos-PAKAPAKA-2705.png',
  ...
  501: '/logo/501-logos-MTV-2705.png',
  509: '/logo/509-CM-20210128.png',
  510: '/logo/510-logos-QUIERO-2705.png',
...
export const channels: Channel[] = [
  ...
  // SPORTS
  createCvattvChannel({ id: 'nba-tv', name: 'NBA TV', shortName: 'NBA', color: '#1d4ed8', number: 2014, url: 'https://cdn.cvattv.com.ar/live/c6eds/NBA_TV/SA_Live_dash_cenc/NBA_TV.mpd', keyId: 'd0c38de3c9844e4e9f975dffb3eff8ad', key: '141ca0fdf6ebadfa7107576b8e09e117' }),
  createCvattvChannel({ id: 'golf-channel', name: 'Golf Channel', shortName: 'Golf', color: '#16a34a', number: 2015, url: 'https://cdn.cvattv.com.ar/live/c6eds/Golf_Channel/SA_Live_dash_cenc/Golf_Channel.mpd', keyId: '38d6226b7cd2cfa86b4b9cdaa455e7d7', key: '24f0ef2bf787647cc02df870417eed2b' }),
  createCvattvChannel({ id: 'tyc-internacional', name: 'TyC Internacional', shortName: 'TyC Intl', color: '#7c3aed', number: 2016, url: 'https://cdn.cvattv.com.ar/live/c3eds/TyC_Internacional/SA_Live_dash_cenc/TyC_Internacional.mpd', keyId: '58e1ebe75d944f6a98ea67b1c7c0a572', key: '1c311b069dbce31ce8e62a6e7e2433eb' }),
  createCvattvChannel({ id: 'america-sports', name: 'America Sports', shortName: 'Am Sports', color: '#4f86f7', number: 2017, url: 'https://cdn.cvattv.com.ar/live/c6eds/America_Sports/SA_Live_dash_cenc/America_Sports.mpd', keyId: 'a0aa01337a2148bda1e21862295ae037', key: 'fee0f87a0527497351fc54ce36ad1de2' }),
  // KIDS
  createCvattvChannel({ id: 'cartoon-network', name: 'Cartoon Network', shortName: 'Cartoon', color: '#f59e0b', number: 302, url: 'https://cdn.cvattv.com.ar/live/c3eds/CartoonNetwork/SA_Live_dash_cenc/CartoonNetwork.mpd', keyId: 'd7df56efaa36a71141d238854cc46d1d', key: '8abb2ee9150d8b2af8ebec0de0f833c8' }),
  createCvattvChannel({ id: 'dreamworks', name: 'Dreamworks', shortName: 'DW Kids', color: '#0ea5e9', number: 2020, url: 'https://cdn.cvattv.com.ar/live/c7eds/Dreamworks/SA_Live_dash_cenc/Dreamworks.mpd', keyId: '7f30c43e47544412221fd64201d92f4b', key: 'f83d09d75a0946b1d71aa48c201b4d8b' }),
  createCvattvChannel({ id: 'boomerang', name: 'Cartoonito', shortName: 'Boomerang', color: '#f97316', number: 301, url: 'https://cdn.cvattv.com.ar/live/c7eds/Boomerang/SA_Live_dash_cenc/Boomerang.mpd', keyId: '5792e613fceb699c79cbc0e75fe4cd37', key: 'a672793730476ed23e5c1bce2ff570c6' }),
  createCvattvChannel({ id: 'baby-tv', name: 'Baby TV', shortName: 'Baby TV', color: '#ec4899', number: 307, url: 'https://cdn.cvattv.com.ar/live/c7eds/BabyTV/SA_Live_dash_cenc/BabyTV.mpd', keyId: '9e09f0a3ecb932582e0f3bc6a6194c8d', key: '6d2363b7ba7680ea3bf6dcbad1efa5bf' }),
  createCvattvChannel({ id: 'tooncast', name: 'Tooncast', shortName: 'Tooncast', color: '#8b5cf6', number: 309, url: 'https://cdn.cvattv.com.ar/live/c6eds/Tooncast/SA_Live_dash_cenc/Tooncast.mpd', keyId: '10638a722eb54c64bfb0e7a77483686a', key: '41a7d3d522e19215b7e8f611b6902d61' }),
  createCvattvChannel({ id: 'nick-jr', name: 'Nick Jr', shortName: 'Nick Jr', color: '#facc15', number: 311, url: 'https://cdn.cvattv.com.ar/live/c6eds/Nick_Jr/SA_Live_dash_cenc/Nick_Jr.mpd', keyId: 'e824b2277a86fd6adfc40aa948e5064a', key: '28da2dbbe8e1a1463bbb23895b922083' }),
  createCvattvChannel({ id: 'kidoo', name: 'Kidoo', shortName: 'Kidoo', color: '#a855f7', number: 2025, url: 'https://cdn.cvattv.com.ar/live/c6eds/Kidoo/SA_Live_dash_cenc/Kidoo.mpd', keyId: 'dcd89337a501ab929c01a039774089dc', key: 'e96cc7be9139a8d581b3f5eebebfc10d' }),

  // MOVIES & SERIES
  createCvattvChannel({ id: 'cinemax', name: 'Cinemax', shortName: 'Cinemax', color: '#0f172a', number: 204, url: 'https://cdn.cvattv.com.ar/live/c6eds/Cinemax/SA_Live_dash_cenc/Cinemax.mpd', keyId: '977928a92b82ba3781741a6470f8f45b', key: '51f4e62827c128f7210b79a11587661a' }),
  createCvattvChannel({ id: 'volver', name: 'Volver', shortName: 'Volver', color: '#7c3aed', number: 213, url: 'https://cdn.cvattv.com.ar/live/c6eds/Volver/SA_Live_dash_cenc/Volver.mpd', keyId: '194e53184a424ce6989ad82c5f28fbc5', key: '65d60c5cc4de031172be0a6a51edbdfe' }),
  createCvattvChannel({ id: 'space', name: 'Space', shortName: 'Space', color: '#1e293b', number: 209, url: 'https://cdn.cvattv.com.ar/live/c3eds/Space/SA_Live_dash_cenc/Space.mpd', keyId: '0942e4ecd1bd3567e8f9447f45c20a12', key: 'efca6264f04cf7373de0c30ec79fe909' }),
  createCvattvChannel({ id: 'tnt-series', name: 'TNT Series', shortName: 'TNT Ser', color: '#2563eb', number: 212, url: 'https://cdn.cvattv.com.ar/live/c3eds/TNTSeries/SA_Live_dash_cenc/TNTSeries.mpd', keyId: '5c14d6aeb19bf113edf91a7b544253cb', key: '8d776d6f9c5c840ebe88d767dd731692' }),
  createCvattvChannel({ id: 'warner-hd', name: 'Warner HD', shortName: 'Warner', color: '#1d4ed8', number: 214, url: 'https://cdn.cvattv.com.ar/live/c7eds/WarnerHD/SA_Live_dash_cenc/WarnerHD.mpd', keyId: '069bd3f0b6c279467e08549f17bf5bd0', key: '5afa7e369a6de1093818a85af912a775' }),
  createCvattvChannel({ id: 'amc-series', name: 'AMC Series', shortName: 'AMC Ser', color: '#7c2d12', number: 215, url: 'https://cdn.cvattv.com.ar/live/c6eds/AMC_Series/SA_Live_dash_cenc/AMC_Series.mpd', keyId: '10d3d4f33a6bad277accc2688c46b406', key: '588fd56bcab1fcdb4f33b5c2f7018d29' }),
  createCvattvChannel({ id: 'a3-series', name: 'A3 Series', shortName: 'A3 Ser', color: '#dc2626', number: 2033, url: 'https://cdn.cvattv.com.ar/live/c7eds/A3_Series/SA_Live_dash_cenc/A3_Series.mpd', keyId: '5e34e08ae5ae440f01a03e505dd24a57', key: 'ed30cc7f5040a75d73f619320249272b' }),
  ...
  createCvattvChannel({ id: 'dhe', name: 'DHE', shortName: 'DHE', color: '#475569', number: 2035, url: 'https://cdn.cvattv.com.ar/live/c7eds/DHE/SA_Live_dash_cenc/DHE.mpd', keyId: 'ff800156f81f70c687eccaadedc2ca15', key: '937ba1301e27008b34d02b9d8a31a0db' }),
  createCvattvChannel({ id: 'pasiones', name: 'Pasiones', shortName: 'Pasiones', color: '#f43f5e', number: 2036, url: 'https://cdn.cvattv.com.ar/live/c7eds/Pasiones/SA_Live_dash_cenc/Pasiones.mpd', keyId: 'd41cf825e878f0d8e276218af7f5b7e1', key: '13d1b73ab578ab8623be9347bcf8972a' }),
  createCvattvChannel({ id: 'telemundo-hd', name: 'Telemundo HD', shortName: 'Telemundo', color: '#c026d3', number: 2037, url: 'https://cdn.cvattv.com.ar/live/c7eds/Telemundo_HD/SA_Live_dash_cenc/Telemundo_HD.mpd', keyId: '53d752e4649dadd808d913985f86ee77', key: 'd1fd24db1b61d634cabfc44538ce9b0e' }),
  createCvattvChannel({ id: 'tbs', name: 'TBS', shortName: 'TBS', color: '#0ea5e9', number: 2038, url: 'https://cdn.cvattv.com.ar/live/c6eds/TBS/SA_Live_dash_cenc/TBS.mpd', keyId: '49a0179b034ae899cb67d8a5834181aa', key: '486e2c6d69adea7e17f2960e8e366612' }),
  createCvattvChannel({ id: 'adult-swim', name: 'Adult Swim', shortName: 'Adult Swim', color: '#0f172a', number: 177, url: 'https://cdn.cvattv.com.ar/live/c3eds/Adult_Swim/SA_Live_dash_cenc/Adult_Swim.mpd', keyId: '9be1432e1e594c8d0648a44d3d9f0c46', key: '8e6c785b14d973c504074b1920f11b15' }),
  createCvattvChannel({ id: 'europa-europa', name: 'Europa Europa', shortName: 'Europa', color: '#2563eb', number: 203, url: 'https://cdn.cvattv.com.ar/live/c6eds/Europa_Europa/SA_Live_dash_cenc/Europa_Europa.mpd', keyId: 'b47f257df0314d09a7f8355c3abe1dc6', key: 'bdc9f1696a82ee7398dd3a7fa82300e2' }),
  createCvattvChannel({ id: 'tcm', name: 'TCM', shortName: 'TCM', color: '#92400e', number: 216, url: 'https://cdn.cvattv.com.ar/live/c6eds/TCM/SA_Live_dash_cenc/TCM.mpd', keyId: 'a5f44a5e30714cf3bcee7c7f15a08b4e', key: 'c3c141ae941ab9750339c3af45a65ce2' }),
  createCvattvChannel({ id: 'paramount', name: 'Paramount', shortName: 'Paramount', color: '#1e3a8a', number: 2042, url: 'https://cdn.cvattv.com.ar/live/c7eds/Paramount/SA_Live_dash_cenc/Paramount.mpd', keyId: 'b85b710ecff3e38f31fc8e249b1c1cef', key: 'a1544c193dde6f8858c9358ee69a60a7' }),

  // HBO
  createCvattvChannel({ id: 'hbo-hd', name: 'HBO HD', shortName: 'HBO', color: '#1d4ed8', number: 150, url: 'https://cdn.cvattv.com.ar/live/c3eds/HBOHD/SA_Live_dash_cenc/HBOHD.mpd', keyId: '5317283f4110fac3fb3a0becd9f648bc', key: '0754a03c926b1247216e01d9dbcfac28' }),
  createCvattvChannel({ id: 'hbo-2', name: 'HBO 2', shortName: 'HBO 2', color: '#2563eb', number: 155, url: 'https://cdn.cvattv.com.ar/live/c6eds/HBO_2/SA_Live_dash_cenc/HBO_2.mpd', keyId: 'c90cc57ad2c436e5a77db2f8d9db2d85', key: '04f6c73984bdcffd013050608497935d' }),
  createCvattvChannel({ id: 'hbo-plus', name: 'HBO Plus', shortName: 'HBO+', color: '#3b82f6', number: 156, url: 'https://cdn.cvattv.com.ar/live/c6eds/HBO_Plus/SA_Live_dash_cenc/HBO_Plus.mpd', keyId: 'f0e7f7d458990edfab7b98b412564615', key: '79205754b7f84a62661c2dbe9de5dd5d' }),
  createCvattvChannel({ id: 'hbo-mundi', name: 'HBO Mundi', shortName: 'HBO Mundi', color: '#60a5fa', number: 154, url: 'https://cdn.cvattv.com.ar/live/c6eds/HBO_Mundi/SA_Live_dash_cenc/HBO_Mundi.mpd', keyId: '7821b2662148fe333d5191acbb8a5c1f', key: 'ae43f3e2545237ebda58b13813b5d328' }),
  createCvattvChannel({ id: 'hbo-pop', name: 'HBO Pop', shortName: 'HBO Pop', color: '#93c5fd', number: 151, url: 'https://cdn.cvattv.com.ar/live/c7eds/HBO_POP/SA_Live_dash_cenc/HBO_POP.mpd', keyId: 'f4e1ce5cef7e9a110fe968f8881b21fa', key: '6bbe2062b150b11496cdd5fbdd9c89d6' }),
  createCvattvChannel({ id: 'hbo-extreme', name: 'HBO Extreme', shortName: 'HBO Xtreme', color: '#1e40af', number: 152, url: 'https://cdn.cvattv.com.ar/live/c6eds/HBO_Extreme/SA_Live_dash_cenc/HBO_Extreme.mpd', keyId: 'd504011bbef467c0de3a7534e302a6d4', key: '334103e2abe16faa7f9ab2e3097c5a58' }),
  createCvattvChannel({ id: 'hbo-family', name: 'HBO Family', shortName: 'HBO Fam', color: '#6d28d9', number: 153, url: 'https://cdn.cvattv.com.ar/live/c6eds/HBO_Family/SA_Live_dash_cenc/HBO_Family.mpd', keyId: '535473132f68082160b489482ca35f8e', key: 'e90fd91fcd3fc809bed2b1c0d37f7297' }),
  createCvattvChannel({ id: 'hbo-signature', name: 'HBO Signature', shortName: 'HBO Sig', color: '#4c1d95', number: 157, url: 'https://cdn.cvattv.com.ar/live/c6eds/HBO_Signature/SA_Live_dash_cenc/HBO_Signature.mpd', keyId: 'e866499fbc1149f49989672075aa3a68', key: 'd2dd5c95623c6343240981c2202fc311' }),

  // UNIVERSAL PACK
  createCvattvChannel({ id: 'universal-premiere', name: 'Universal Premiere', shortName: 'U Premiere', color: '#0f172a', number: 2051, url: 'https://cdn.cvattv.com.ar/live/c6eds/Universal_Premiere/SA_Live_dash_cenc/Universal_Premiere.mpd', keyId: '0eb20b51ad13b58ad417f11318e588b3', key: 'ad5d29a33d73d21187157802de8e6097' }),
  createCvattvChannel({ id: 'universal-cinema', name: 'Universal Cinema', shortName: 'U Cinema', color: '#1e293b', number: 2052, url: 'https://cdn.cvattv.com.ar/live/c6eds/Universal_Cinema/SA_Live_dash_cenc/Universal_Cinema.mpd', keyId: 'f6ae2e17173055e4ca69dc18963406ae', key: '5a955c29eb88a0b4c9a2538cc4b3aea2' }),
  createCvattvChannel({ id: 'universal-comedy', name: 'Universal Comedy', shortName: 'U Comedy', color: '#334155', number: 2053, url: 'https://cdn.cvattv.com.ar/live/c6eds/Universal_Comedy/SA_Live_dash_cenc/Universal_Comedy.mpd', keyId: '062c5d25105a3a935b67e36923c73f28', key: '88c2d4cec420f18d2477152c66c7870d' }),
  createCvattvChannel({ id: 'universal-crime', name: 'Universal Crime', shortName: 'U Crime', color: '#475569', number: 2054, url: 'https://cdn.cvattv.com.ar/live/c6eds/universal_Crime/SA_Live_dash_cenc/universal_Crime.mpd', keyId: '1efd7edf60e1514f775dd13d046ae708', key: 'c2ef1abbd945c62c11b1375eaaa50f0d' }),
  createCvattvChannel({ id: 'universal-reality', name: 'Universal Reality', shortName: 'U Reality', color: '#64748b', number: 2055, url: 'https://cdn.cvattv.com.ar/live/c6eds/Universal_Reality/SA_Live_dash_cenc/Universal_Reality.mpd', keyId: 'cedd9c1a5c2ae43f80ee3197212016d6', key: 'bf47a3c39e164a97ea6adc4c8dd57435' }),

  // VARIETY
  createCvattvChannel({ id: 'lifetime', name: 'Lifetime', shortName: 'Lifetime', color: '#c026d3', number: 218, url: 'https://cdn.cvattv.com.ar/live/c6eds/Lifetime/SA_Live_dash_cenc/Lifetime.mpd', keyId: 'eae51b1d67ff47adac7b6bd3a4b1120a', key: 'b4d6bb47193f33ffc12379cdc447455d' }),
  createCvattvChannel({ id: 'food-network', name: 'Food Network', shortName: 'Food', color: '#ea580c', number: 403, url: 'https://cdn.cvattv.com.ar/live/c6eds/Food_Network/SA_Live_dash_cenc/Food_Network.mpd', keyId: '6ca0fbad21a0e908c0280dcc27e6ee0e', key: '62670eedbafdf9360b4ecaed738e26cd' }),
  createCvattvChannel({ id: 'hola-tv', name: 'Hola TV', shortName: 'Hola TV', color: '#f43f5e', number: 2058, url: 'https://cdn.cvattv.com.ar/live/c7eds/Hola_TV/SA_Live_dash_cenc/Hola_TV.mpd', keyId: '5d759477f0ad1bdef2c6de09e7c275fd', key: '82cc6eea185eecc934df95adfbbf9dbc' }),
  createCvattvChannel({ id: 'canal-rural', name: 'Canal Rural', shortName: 'Rural', color: '#65a30d', number: 401, url: 'https://cdn.cvattv.com.ar/live/c6eds/Canal_Rural/SA_Live_dash_cenc/Canal_Rural.mpd', keyId: 'b02c568163c14cfda4ddb958a0aab742', key: 'ef64a70ac85a663a3308be6476610aad' }),
  createCvattvChannel({ id: 'senal-maria', name: 'Señal Maria', shortName: 'S. Maria', color: '#2563eb', number: 23, url: 'https://cdn.cvattv.com.ar/live/c3eds/Senal_Maria/SA_Live_dash_cenc/Senal_Maria.mpd', keyId: 'd456fba3fccb4c06a0f4776fe412400b', key: 'ca5530ffe42a38759d3887c82d6a909a' }),
  createCvattvChannel({ id: 'ewtn', name: 'EWTN', shortName: 'EWTN', color: '#1d4ed8', number: 410, url: 'https://cdn.cvattv.com.ar/live/c6eds/EWTN/SA_Live_dash_cenc/EWTN.mpd', keyId: '07df3c48652a431ab779d133f085b799', key: 'ee2fbeec1ecdffa5617383f684dfda0e' }),
  createCvattvChannel({ id: 'canal-luz', name: 'Canal Luz', shortName: 'Canal Luz', color: '#eab308', number: 2062, url: 'https://cdn.cvattv.com.ar/live/c7eds/CANAL_LUZ/SA_Live_dash_cenc/CANAL_LUZ.mpd', keyId: 'f7523ea5a2da78c465d928be1d81e2a5', key: '870ad69e98abd52b443bd8f0204b3bc4' }),

  // DOCUMENTARY
  createCvattvChannel({ id: 'theater-hd', name: 'Theater HD', shortName: 'Theater', color: '#7c3aed', number: 183, url: 'https://cdn.cvattv.com.ar/live/c6eds/Theater_HD/SA_Live_dash_cenc/Theater_HD.mpd', keyId: '5279c05ea51c4dae8e7fa6be88448089', key: 'b28dfafba4b848dfd5d7c177ebf19108' }),
  ...
  // MUSIC
  createCvattvChannel({ id: 'vorterix', name: 'Vorterix', shortName: 'Vorterix', color: '#ef4444', number: 2065, url: 'https://cdn.cvattv.com.ar/live/c6eds/Vorterix/SA_Live_dash_cenc/Vorterix.mpd', keyId: 'eabe2c22350c26c7f0ad84b34932f08d', key: '39fa06836ec0f81d8dd9b6e01a3070e3' }),
  createCvattvChannel({ id: 'allegro-hd', name: 'Allegro HD', shortName: 'Allegro', color: '#f59e0b', number: 2066, url: 'https://cdn.cvattv.com.ar/live/c7eds/AllegroHD/SA_Live_dash_cenc/AllegroHD.mpd', keyId: 'e55e61b81b992d6c21466891d72157e9', key: '566d341bf7209a88976e75c20ad7aca2' }),
  createCvattvChannel({ id: 'mtv-00', name: 'MTV 00', shortName: 'MTV 00', color: '#d946ef', number: 2067, url: 'https://cdn.cvattv.com.ar/live/c7eds/MTV00/SA_Live_dash_cenc/MTV00.mpd', keyId: '1f0c09ed9e5841cf867ba6eb3cdfd61d', key: '802c89c6bae6a245aaafcf40c1986fc1' }),
  createCvattvChannel({ id: 'htv', name: 'HTV', shortName: 'HTV', color: '#a855f7', number: 508, url: 'https://cdn.cvattv.com.ar/live/c6eds/HTV/SA_Live_dash_cenc/HTV.mpd', keyId: 'daecef5fe32f4ce083c6a0c692755d6a', key: 'd4227f24389a9ba77293214b93eb0d7d' }),
  createCvattvChannel({ id: 'mtv-hits', name: 'MTV Hits', shortName: 'MTV Hits', color: '#c026d3', number: 2069, url: 'https://cdn.cvattv.com.ar/live/c6eds/MTV_Hits/SA_Live_dash_cenc/MTV_Hits.mpd', keyId: '61008dfc867544cd872de99b1f2b82cf', key: '716449756316b91c54803aaa22a2fbf0' }),
  createCvattvChannel({ id: 'nickmusic', name: 'Nickmusic', shortName: 'Nickmusic', color: '#facc15', number: 2070, url: 'https://cdn.cvattv.com.ar/live/c6eds/Nickmusic/SA_Live_dash_cenc/Nickmusic.mpd', keyId: 'eae6c12ccab349e6ae675ab6ed8a476c', key: '4a4fd86ea9db4417ec86c237d3111b18' }),
  createCvattvChannel({ id: 'flow-music-xp', name: 'Flow Music XP', shortName: 'Flow XP', color: '#0ea5e9', number: 2071, url: 'https://cdn.cvattv.com.ar/live/c7eds/Flow_Music_XP/SA_Live_dash_cenc/Flow_Music_XP.mpd', keyId: 'b2aae44a74144be8b2118e20d1412bab', key: '8a7ae996d12d8d5d5637d1044f8e08b7' }),
  createCvattvChannel({ id: 'flow-music-1', name: 'Flow Music 1', shortName: 'Flow 1', color: '#38bdf8', number: 2072, url: 'https://cdn.cvattv.com.ar/live/c7eds/Flow_Music_1/SA_Live_dash_cenc/Flow_Music_1.mpd', keyId: 'f34cd7709f093d23d4db009107d96862', key: 'd8a829138d970b45e867c9733a31b2f0' }),
  createCvattvChannel({ id: 'flow-music-2', name: 'Flow Music 2', shortName: 'Flow 2', color: '#7dd3fc', number: 2073, url: 'https://cdn.cvattv.com.ar/live/c7eds/Flow_Music_2/SA_Live_dash_cenc/Flow_Music_2.mpd', keyId: '596b599580b39ae2f3c413f7eae36902', key: '2d7e3d5d31f68690fd877a111f84e8e3' }),
  createCvattvChannel({ id: 'flow-music-3', name: 'Flow Music 3', shortName: 'Flow 3', color: '#bae6fd', number: 2074, url: 'https://cdn.cvattv.com.ar/live/c7eds/Flow_Music_3/SA_Live_dash_cenc/Flow_Music_3.mpd', keyId: 'e078b15ed770ec71f803c0ecc43de033', key: '7010bccda544f74d1b425c4cebd082d4' }),

  // INTERNATIONAL
  createCvattvChannel({ id: 'bloomberg', name: 'Bloomberg', shortName: 'Bloomberg', color: '#0f172a', number: 2075, url: 'https://cdn.cvattv.com.ar/live/c3eds/Bloomberg/SA_Live_dash_cenc/Bloomberg.mpd', keyId: '1e50891cdc64452aae20d049727f2f3f', key: '551871ba1dc6a95597ec0cb82eb3b2a4' }),
  createCvattvChannel({ id: 'cnn-espanol', name: 'CNN en Español', shortName: 'CNN Esp', color: '#dc2626', number: 609, url: 'https://cdn.cvattv.com.ar/live/c6eds/CNN_en_Espanol/SA_Live_dash_cenc/CNN_en_Espanol.mpd', keyId: '0b20ed9da0e5457c9dfd3ae0b6092491', key: '98997a7020c18cb28174a2490147830a' }),
  createCvattvChannel({ id: 'cnn-internacional', name: 'CNN Internacional', shortName: 'CNN Intl', color: '#ef4444', number: 608, url: 'https://cdn.cvattv.com.ar/live/c6eds/CNN_Internacional/SA_Live_dash_cenc/CNN_Internacional.mpd', keyId: '9f24708ad1184ee3a04b650941f9894b', key: 'e5bc7c5ff392119423dbf1c023a7b21c' }),
  createCvattvChannel({ id: 'bbc-world', name: 'BBC World News', shortName: 'BBC World', color: '#dc2626', number: 2078, url: 'https://cdn.cvattv.com.ar/live/c6eds/BBC_World_News/SA_Live_dash_cenc/BBC_World_News.mpd', keyId: '019f72f2091d4cbea59ff8c85b117f86', key: 'a4eac51195506752f9f63ad24def9c37' }),
  createCvattvChannel({ id: 'fox-news', name: 'Fox News', shortName: 'Fox News', color: '#1d4ed8', number: 611, url: 'https://cdn.cvattv.com.ar/live/c6eds/Fox_News/SA_Live_dash_cenc/Fox_News.mpd', keyId: '3fe3f31a5e7b48a1b548e9364757ce66', key: '32993fc281207fe915f6f1e990957868' }),
  createCvattvChannel({ id: 'al-jazeera', name: 'Al Jazeera', shortName: 'Al Jazeera', color: '#f59e0b', number: 2080, url: 'https://cdn.cvattv.com.ar/live/c7eds/Alljazzera/SA_Live_dash_cenc/Alljazzera.mpd', keyId: '137a1a70fa118b695118a3aad9485b13', key: '7c35ca36d4452dfa03d88725a0d16105' }),
  createCvattvChannel({ id: 'euronews', name: 'Euronews', shortName: 'Euronews', color: '#2563eb', number: 2081, url: 'https://cdn.cvattv.com.ar/live/c6eds/Euronews/SA_Live_dash_cenc/Euronews.mpd', keyId: 'd86b0f56d32f45adb0a6b4e488c8f0c2', key: 'e4f180b0e61be3e80ab602df5e56ff3f' }),
  createCvattvChannel({ id: 'dw', name: 'DW', shortName: 'DW', color: '#0f172a', number: 610, url: 'https://cdn.cvattv.com.ar/live/c6eds/DW/SA_Live_dash_cenc/DW.mpd', keyId: 'e21fc12c6ee185fbc90a052b05026be9', key: '0f96fd52903707aac0b42853a043ffd0' }),
  createCvattvChannel({ id: 'france-24', name: 'France 24', shortName: 'France 24', color: '#dc2626', number: 603, url: 'https://cdn.cvattv.com.ar/live/c6eds/France_24/SA_Live_dash_cenc/France_24.mpd', keyId: '72187f2651724db18505cdcad435841d', key: '6f41e05476e34edf7bb9dc51f08f95df' }),
  createCvattvChannel({ id: 'tv5-monde', name: 'TV5 Monde', shortName: 'TV5', color: '#7c3aed', number: 602, url: 'https://cdn.cvattv.com.ar/live/c6eds/TV5_Monde/SA_Live_dash_cenc/TV5_Monde.mpd', keyId: '62034ff5988b4787b17cdf6f751a3142', key: 'b3938f0af28b4c0c082b0d4210e389a0' }),
  createCvattvChannel({ id: 'antena-3', name: 'Antena 3', shortName: 'Antena 3', color: '#ea580c', number: 2085, url: 'https://cdn.cvattv.com.ar/live/c6eds/Antena_3/SA_Live_dash_cenc/Antena_3.mpd', keyId: '1e1ad422a6714482b66fa702c16e50c6', key: '4fdf28a0ab91356ca55a75f4e9bf8c92' }),
  createCvattvChannel({ id: 'telesur', name: 'Telesur', shortName: 'Telesur', color: '#15803d', number: 600, url: 'https://cdn.cvattv.com.ar/live/c6eds/Telesur/SA_Live_dash_cenc/Telesur.mpd', keyId: '5235d8ee29f14ce6b26ea5d828aee77a', key: '6bf6bd339e3098babc2ab0b984cd2376' }),
  createCvattvChannel({ id: 'bandeirantes', name: 'Bandeirantes', shortName: 'Band', color: '#1d4ed8', number: 2087, url: 'https://cdn.cvattv.com.ar/live/c7eds/Bandeirantes/SA_Live_dash_cenc/Bandeirantes.mpd', keyId: '0b4f56d5c19b45fb3e75a73b6ec06e6c', key: 'c464e2b6ded2b52e1e7753b3a859abce' }),
  createCvattvChannel({ id: 'rede-record', name: 'Rede Record', shortName: 'Record', color: '#be123c', number: 2088, url: 'https://cdn.cvattv.com.ar/live/c3eds/Rede_Record/SA_Live_dash_cenc/Rede_Record.mpd', keyId: 'b0bd8ea11b3f4c219903085ef1d44b0d', key: '9a25709a72c2ca93cb738665736cfa5a' }),
  createCvattvChannel({ id: 'argentinisima', name: 'Argentinísima', shortName: 'Argent.', color: '#64748b', number: 2089, url: 'https://cdn.cvattv.com.ar/live/c6eds/Argentinisima/SA_Live_dash_cenc/Argentinisima.mpd', keyId: 'a6243f46366445ebbf3117ec27365481', key: '81667cdc3bcf19a6a66c0919fa00a20b' }),
  createCvattvChannel({ id: 'arirang', name: 'Arirang', shortName: 'Arirang', color: '#0f766e', number: 612, url: 'https://cdn.cvattv.com.ar/live/c7eds/Arirang/SA_Live_dash_cenc/Arirang.mpd', keyId: '436d78a75fad9bdcc6d409640c116a62', key: 'c77471ac3b694513a9c5ff68b8d4fac5' }),
]
